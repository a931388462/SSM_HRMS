...
<script type="text/javascript">
    ...
    $(".emp_edit_btn").click(function () {
        ...
        $.ajax({
            url:"${pageContext.request.contextPath}" + "/hrms/emp/getEmpById/"+updateEmpId,
            type:"GET",
    ...
    $(".emp_update_btn").click(function () {
        ...
        $.ajax({
            url:"${pageContext.request.contextPath}" + "/hrms/emp/updateEmp/"+updateEmpId,
            type:"PUT",
            ...
            success:function (result) {
                if (result.code==100){
                    ...
                    //跳转到当前页
                    var curPage = ${curPage};
                    window.location.href="${pageContext.request.contextPath}"+ "/hrms/emp/getEmpList?pageNo="+curPage;
                }else {
